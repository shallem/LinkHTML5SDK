...
var m = Math,
    ...
    /**
     * SAH: we only support browsers with transform.
     * hasTransform = !!vendor
     */
    hasTransform=true,
	...
	iScroll = function (el, options) {
		...
		if (that.options.useTransition) that.options.fixedScrollbar = true;
                ...
                /* SAH: added init function that takes in either CSS or DOM object.
                 * Use this function to allow the underlying scroller to be refreshed
                 * dynamically using JSF partial updates. Also MUST be after the
                 * options object is instantiated.
                 */
		that._initWrapper(el);
                if (that.scroller !== undefined) {
                    that.refresh();
                }
