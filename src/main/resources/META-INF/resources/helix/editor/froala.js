    ...
    $.widget('helix.editor', {
        ...
        _create: function () {            
            ...
            let e = this.editor = new FroalaEditor('#' + this.element.attr('id'), {
                ...
                _self.element.find('.fr-view').css('font-family', _self.options.defaultFont).css('font-size', _self.options.defaultFontSize + e.opts.fontSizeUnit);
            });
        },
        isDirty: function () {
        ...
        getHTML: function () {
            return '<html><head><style>' + FROALA_HTML_STYLES + '</style></head><body>' + this.editor.html.get() + '</body></html>';
        },
        blur: function () {
        },
        getFrame: function() {
