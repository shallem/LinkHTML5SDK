(function ($) {
    ...
    var FROALA_HTML_STYLES = 
            ...
            + /*Added by SAH*/ '.fr-view .hx-fr-ignore table td {border: inherit;}.fr-view p{ margin: unset; }'
            + /* For signatures */ ".ql-font-arial {font-family: 'Arial', sans-serif;}.ql-font-arialblack {font-family: 'Arial Black', sans-serif;}.ql-font-calibri {font-family: 'Calibri', sans-serif;}.ql-font-cambria {font-family: 'Cambria', sans-serif;}.ql-font-courier {font-family: 'Courier New', sans-serif;}.ql-font-georgia {font-family: 'Georgia', sans-serif;}.ql-font-impact {font-family: 'Impact', sans-serif;}.ql-font-tahoma {font-family: 'Tahoma', sans-serif;}.ql-font-times {font-family: 'Times New Roman', sans-serif;}.ql-font-trebuchet {font-family: 'Trebuchet MS', sans-serif;}.ql-font-verdana {font-family: 'Verdana', sans-serif;}"
            + /* For outline-style lists */ ".fr-view ol.hx-upper-alpha ol li {list-style: decimal;}.fr-view ol ol li {list-style: upper-alpha;}.fr-view ol ol ol li {list-style: lower-alpha !important;}.fr-view ol ol ol ol li {list-style: lower-roman !important;}.fr-view ol ol ol ol ol li {list-style: disc !important;}"
    ;
})(jQuery);
