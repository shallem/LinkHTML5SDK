...
// function for adding/overriding defaults
    ...
    function Header(calendar, options) {
        ...
        function renderSection(position) {
            ...
            if (Helix.Utils.isString(buttonStr)) {
...
// TODO: use same function formatDate(date, [date2], format, [options])
    ...
    var dateFormatters = {
        ...
        ss: function (d) {
            return zeroPad(d.getUTCSeconds())
        },
        m: function (d) {
            return d.getUTCMinutes()
        },
        mm: function (d) {
            return zeroPad(d.getUTCMinutes())
        },
        h: function (d) {
            return d.getUTCHours() % 12 || 12
        },
        hh: function (d) {
            return zeroPad(d.getUTCHours() % 12 || 12)
        },
        H: function (d) {
        ...
        dd: function (d) {
            return zeroPad(d.getUTCDate())
        },
        ddd: function (d, o) {
            return o.dayNamesShort[d.getUTCDay()]
        },
        dddd: function (d, o) {
            return o.dayNames[d.getUTCDay()]
        },
        M: function (d) {
            return d.getUTCMonth() + 1
        },
        MM: function (d) {
            return zeroPad(d.getUTCMonth() + 1)
        },
        MMM: function (d, o) {
            return o.monthNamesShort[d.getUTCMonth()]
        },
        MMMM: function (d, o) {
            return o.monthNames[d.getUTCMonth()]
        },
        yy: function (d) {
            return (d.getUTCFullYear() + '').substring(2)
        },
        yyyy: function (d) {
        ...
        tt: function (d) {
            return '<span class="fc-ampm">' + (d.getUTCHours() < 12 ? 'am' : 'pm') + '</span>'
        },
        T: function (d) {
            return d.getUTCHours() < 12 ? 'A' : 'P'
        },
