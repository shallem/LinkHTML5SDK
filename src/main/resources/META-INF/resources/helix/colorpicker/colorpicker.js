 ...
 (function($) {
    var ColorPicker = function() {
        ...
        downSelector = function(ev) {
            ...
            current.preview = current.cal.data('colorpicker').livePreview;
            $(this).on('mouseup touchend', current, upSelector);
            $(this).on('mousemove touchmove', current, moveSelector);
        },
        ...
        upSelector = function(ev) {
            fillRGBFields(ev.data.cal.data('colorpicker').color, ev.data.cal.get(0));
            fillHexFields(ev.data.cal.data('colorpicker').color, ev.data.cal.get(0));
            $(ev.target).closest('div.colorpicker_color').off('mouseup touchend');
            $(ev.target).closest('div.colorpicker_color').off('mousemove touchmove');
