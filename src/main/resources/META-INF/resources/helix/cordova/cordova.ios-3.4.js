 ...
 */
    ...
    function iOSExec() {
        ...
        commandQueue.push(commandStr);
        window.cordovaCommandLog.push(commandStr);
        if (window.cordovaCommandLog.length > 50) {
            window.cordovaCommandLog.shift();
        }
